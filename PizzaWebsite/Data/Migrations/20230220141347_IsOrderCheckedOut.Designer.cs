...
namespace PizzaWebsite.Migrations
{
    ...
    [Migration("20230220141347_IsOrderCheckedOut")]
    partial class IsOrderCheckedOut
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaWebsite.Models.CartItem", b =>
                {
                    ...
                    b.Property<bool>("IsOrderCheckedOut")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PizzaWebsite.Models.Topping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaWebsite.Models.Drink", b =>
                {
            ...
            modelBuilder.Entity("PizzaTopping", b =>
                {
                    b.HasOne("PizzaWebsite.Models.Pizza", null)
                        .WithMany()
                        .HasForeignKey("PizzasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaWebsite.Models.Topping", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PizzaWebsite.Models.CartItem", b =>
                {
                    b.HasOne("PizzaWebsite.Models.Order", "Order")
                        .WithMany("CartItems")
                        .HasForeignKey("OrderId");

                    b.HasOne("PizzaWebsite.Models.Product", "Product")
                        .WithMany("CartItems")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaWebsite.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("CartItems")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
